...
| iwin | game_job | `partition-table-creation` | 每日 / 每月分表建立 | 中低 | Step 3 | 專案存在 / code-backed；目前未見 Nick direct path evidence | 否，先作面試素材 | Step 4 |
...
- `game_job partition-table-creation` 已完成 Step 3；下一步應轉成正式面試 case。
...
| --- | --- | --- | --- | --- | --- | --- |
| 1 | iwin | game_job | `partition-table-creation` | 每日 / 每月分表建立 | Step 3 已完成；下一步轉正式面試 case | `iwin game_job partition-table-creation Step 4` |
