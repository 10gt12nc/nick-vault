...
- 若目標是差異化面試題，`*-math fixed-multi-bet-currency-math-core-compatibility` Step 5 已完成；下一步回 Step 2 ranking 做 `rtp-reel-strip-simulation-validation Step 3`。
...
- `*-math fixed-multi-bet-currency-math-core-compatibility` Step 5 已完成，下一步回 Step 2 ranking 做 Rank 2。
...
| 9 | antplay | `*-math` | `rtp-reel-strip-simulation-validation` | RTP / 輪帶模擬與驗證 | `fixed-multi-bet-currency-math-core-compatibility` 已完成 Step 5；下一條補 slot math 差異化最高的 simulation / validation 題材 | `antplay *-math rtp-reel-strip-simulation-validation Step 3` |
