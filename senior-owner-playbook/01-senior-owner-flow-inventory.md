...
- `third_games_api oneapi-wallet-bet-result Step 5` 已完成；若 Nick 要回原 iwin queue，下一步是 `iwin third_games_api antplay-bet-settle-rollback Step 3`。
...
| --- | --- | --- | --- | --- | --- | --- |
| 1 | iwin | third_games_api | `antplay-bet-settle-rollback` | Antplay 投注 / 結算 / rollback 三段式流程 | GSC 與 OneAPI 已完成 Step 5；下一條回 Step 2 ranking 第三候選，對照舊版 Antplay bet / settle / rollback state transition | `iwin third_games_api antplay-bet-settle-rollback Step 3` |
