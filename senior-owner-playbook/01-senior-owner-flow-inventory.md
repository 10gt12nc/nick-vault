...
- 若目標是最快產出 Senior Backend 履歷素材，`payment-provider-callback Step 5` 已完成，`withdrawal-auto-review-refund Step 4` 也已完成；下一條優先做 `withdrawal-auto-review-refund Step 5`。
...
| iwin | payment | `withdrawal-auto-review-refund` | 玩家提款、自動審核 / 自動出款與失敗退款 | 高 | Step 4 | 專案存在 / code-backed；Nick 貢獻待確認 | 否 | `iwin payment withdrawal-auto-review-refund Step 5` |
...
- 下一步是 Step 5 claim gate，檢查是否更新正式履歷 / 自傳。
- 目前仍需要 Nick 本人 evidence 才能升級。
...
| --- | --- | --- | --- | --- | --- | --- |
| 1 | iwin | payment | `withdrawal-auto-review-refund` | 提款自動審核 / 自動出款 / 失敗退款 | Step 4 已完成；下一步做 claim gate，預期仍需 Nick 本人 evidence | `iwin payment withdrawal-auto-review-refund Step 5` |
