...
- 下一步不再慣性推 flow；沒有特定 JD 時，先從 Payment provider case 開始做口說實戰練習。有實際 JD 時，才客製 `08` 與談薪說法 `17`。
