...
- 若目標是差異化面試題，`*-math fixed-multi-bet-currency-math-core-compatibility` Step 5 已完成，`rtp-reel-strip-simulation-validation` Step 5 已完成；下一步回 Step 2 ranking 做 `buy-free-scatter-rtp3-result-contract Step 3`。
...
- `*-math fixed-multi-bet-currency-math-core-compatibility` Step 5 已完成，`rtp-reel-strip-simulation-validation` Step 5 已完成，下一步回 Step 2 ranking 做 Rank 3。
...
| 9 | antplay | `*-math` | `buy-free-scatter-rtp3-result-contract` | Buy Free / Scatter / RTP_3 結果契約 | 前兩條代表 flow 已完成 Step 5；下一條補 buy free / scatter / result contract 的 runtime 與面試素材 | `antplay *-math buy-free-scatter-rtp3-result-contract Step 3` |
