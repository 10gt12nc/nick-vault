...
- 若目標是差異化面試題，`*-math fixed-multi-bet-currency-math-core-compatibility` Step 5 已完成，`rtp-reel-strip-simulation-validation` Step 5 已完成，`buy-free-scatter-rtp3-result-contract` Step 5 已完成；下一步回 Step 2 ranking 做 `jackpot-symbol-hit-and-prize-scaling Step 3`。
...
- `*-math fixed-multi-bet-currency-math-core-compatibility` Step 5 已完成，`rtp-reel-strip-simulation-validation` Step 5 已完成，`buy-free-scatter-rtp3-result-contract` Step 5 已完成，下一步回 Step 2 ranking 做 Rank 4 `jackpot-symbol-hit-and-prize-scaling Step 3`。
...
| 9 | antplay | `*-math` | `jackpot-symbol-hit-and-prize-scaling` | Jackpot symbol hit / prize scaling | Step 2 Rank 4；前三條代表 flow 已完成 Step 5，下一條可補 money-like prize scaling | `antplay *-math jackpot-symbol-hit-and-prize-scaling Step 3` |
