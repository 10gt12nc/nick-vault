...
| 10 | ugsoft | ugsoft-connector-api | `transfer-wallet-in-out-query` | UGSoft transfer wallet in / out / query | 可選加強：Step 1 / Step 2 / Step 3 已完成；若 Nick 要補非 iwin 廣度，先把第一順位 transfer wallet flow 轉成 Step 4 面試 case，再視需要補 callback / MQ sync | `ugsoft ugsoft-connector-api transfer-wallet-in-out-query Step 4` |
