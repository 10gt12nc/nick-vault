...
| iwin | game_job | `online-payment-data-cleaning` | 充值 / 提現資料清洗與每日經濟資料 | 中 | Step 3 | 專案存在 / code-backed；目前未見 Nick direct path evidence | 否，先作面試素材 | Step 4 |
...
- `game_job online-payment-data-cleaning` 已完成 Step 3；下一步應轉成正式面試 case。
...
| --- | --- | --- | --- | --- | --- | --- |
| 1 | iwin | game_job | `online-payment-data-cleaning` | 充值 / 提現資料清洗與每日經濟資料 | Step 3 已完成；下一步轉正式面試 case | `iwin game_job online-payment-data-cleaning Step 4` |
