...
> 狀態：2026-05-20 依目前所有 Contribution Claim Consolidation 匯總。這版先給投遞 / 履歷使用；後續 flow 深掃與新 evidence 會再回填修正。
