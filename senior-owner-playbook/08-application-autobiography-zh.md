...
- 工程與維運理解：Docker、K3s、rollout / rollback analysis、OpenObserve、log tracing、git history / diff 追蹤、legacy system takeover、跨 repo system reconstruction、AI-assisted engineering workflow、knowledge-base driven development、payment / slot math workspace 開發與驗證閉環。
...
- 非同步與批次：Kafka、RabbitMQ、ActiveMQ、Quartz、batch job、report projection、retry / compensation、idempotency、reconciliation risk analysis。
