...
Nick 目前不是缺人生方向，也不是缺努力；真正要避免的是同時把太多支線升級成主線。接下來 1-3 年的主軸先收斂成三件事：

- 主業升級：Java Backend -> Senior Backend -> Platform Backend / System Owner 候選。
- 健康穩定：重訓、飲控、睡眠與可持續節奏。
- 現金安全感：先補足緊急預備金，再談更複雜的投資配置。

未來 12 個月真正要交付的是：

- 整理並講熟 5-10 個 production case。
- 更新履歷 / 自傳 / 面試 case，取得外部市場回饋。
- 現金安全墊接近 27-30 萬。
- 每週維持重訓與基本飲控。
- 不再把遊戲開發、日文、英文、證照、課程、ETF 細節或 side project 升級成翻身主線。

判斷一件事要不要做時，先問：

```text
這件事是在幫主線累積，還是在幫焦慮找出口？
```

如果是幫主線累積，可以做；如果只是幫焦慮找出口，先停。遊戲開發目前只保留為興趣與架構素材；日文是興趣，英文是技術工具；書和課只有在 30 天內能用於工作、面試或 case 整理時才買。
