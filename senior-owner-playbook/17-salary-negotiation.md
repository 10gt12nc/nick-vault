...
不要因為擔心沒有 offer 就主動把自己壓到一般 4 年 CRUD Java 後端價位。
...
```text
月薪 110,000-130,000，或年薪 150-180 萬，可依職務範圍、獎金結構與整體 package 討論。
```
...
```text
我目前會以年薪 150-180 萬作為主要期待，實際會看職務範圍與整體 package。如果職務內容包含核心金流、provider 串接、高交易 flow、MQ / Kafka 或平台穩定性維護，我會希望落在區間中上段；若團隊成長性與技術深度足夠，也可以依整體條件討論。
```
...
```text
我理解每家公司都有既有薪資區間。不過以我目前希望承擔的職務範圍，包含第三方 provider、金流 / 錢包、高交易 flow 與既有系統維護，我會希望整體 package 至少能接近年薪 150 萬。如果月薪較低，可能需要看年終、分紅、職責範圍與成長性是否能補足。
```
