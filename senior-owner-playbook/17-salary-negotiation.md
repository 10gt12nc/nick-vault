...
| 市場層級 | 月份 | 判斷 |
| --- | --- | --- |
| Tier 1 | `2-5 月` | 最大招聘波。年後轉職潮、新年度 budget / HC 開出來，職缺與流動通常最大。2026 因春節較晚與轉職季拉長，市場資料顯示高峰可延到 `4-5 月`。 |
| Tier 2 | `9-10 月` | 第二波招聘。科技 / 工程 / 外商 / 中高階缺可能因 Q4 前補人、專案啟動或預算調整再開一波。 |
| Tier 3 | 全年其他月份 | 仍然有職缺，尤其 4-5 年以上後端常見離職替補、專案急補或臨時 HC；只是整體流量不是主要高峰。 |

補充判斷：

- `11-1 月`：不是黃金期，比較像準備 / 卡位 / 少量接觸期；適合開履歷、跟獵頭聊、同步 104 / LinkedIn，提前卡年後職缺。
- `6-8 月`：普通偏淡，畢業 / 校招波對 Senior Backend 不是最佳主戰場，但仍可能有補人。
- `12 月`：通常偏淡，但不代表完全沒缺。

市場節奏和 Nick 的個人準備節奏要分開看。`7 月 / 8 月 / 11-1 月` 出現在計畫裡，是因為 Nick 在整理、複習、補洞，不代表它們是求職黃金月。

對 Nick 的建議節奏：

```text
2026/07：整理履歷、自我介紹、三個專案故事
2026/08：Production Flow、技術複習、模擬面試
2026/09-10：第一波正式市場驗證，目標是面試、拿回饋、爭取 offer
2026/11-2027/01：整理第一波面試回饋與補洞，維持少量投遞
2027/02-05：第二波擴大投遞，吃最大招聘季
之後：每季面試 3-5 間，持續 market check
```

`2026/09-10` 不是暖身，也不是模擬考，而是第一波正式市場驗證；只是規模可以比 2027 春季小。`2027/02-05` 不是真正開始，而是帶著第一波回饋的第二波擴大投遞。

重點不是押某個月份，而是不要等旺季才準備，也不要把真正行動拖到 2027。旺季只是職缺流量變大；真正會影響薪資與錄取的是 `08 / 04 / 17 / 19` 是否對齊、3-5 條 production case 能否抗追問，以及面試回饋是否有被回填修正。

各月份重點：

| 時間 | 主軸 | 必做 | 不做 |
| --- | --- | --- | --- |
| 2026/07 | 履歷、自我介紹、三個專案故事 | 讀 `19` 最終敘事總結、`08` A 版、`05` claim / boundary；練 90 秒自我介紹；三個 story 練到 30 秒 / 90 秒 | 不追求技術題全補完，不重開題庫 |
| 2026/08 | Production Flow、技術複習、模擬面試 | 主力 7 條 flow 每條抓六點；三個 story 練到 3 分鐘；30 題核心跑一輪；每週 QA 1-2 次 | 不把 JVM / Redis / Kafka / System Design 全部開成新主線 |
| 2026/09-10 | 第一波正式市場驗證 | 每週投遞；面試後記錄追問；依回饋修 `08 / story / flow` 回答；練 HR / 談薪 / 離職原因 | 不把這波當暖身；不因幾場痛苦面試縮回無限準備 |
| 2026/11-2027/01 | 回饋補洞 | 整理 9-10 月面試題；補最常被追問的 flow；補最常被打穿的基本功；維持少量投遞 | 不全 repo 深掃，不新增 side project 主線 |
| 2027/02-05 | 第二波擴大投遞 | 擴大投遞、JD-specific 客製、每週 QA、每場面試後回填追問、薪資談判與 offer 比較 | 不從零準備，不把第一波回饋放掉 |
