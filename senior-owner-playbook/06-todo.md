...
1. `ugsoft-connector-api request-bet-record-mq-sync Step 4`；第一條 `transfer-wallet-in-out-query` 已完成 Step 5，第二條 callback / MQ flow 已完成 Step 5，第三條 job-driven sync flow 已完成 Step 3，後續可補正式面試 case
