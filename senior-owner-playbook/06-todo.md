...
- 2026-06-26：Week 01-03 早期試跑 packet 已從 `backend-learning-log.md` 清除，`backend-weekly-plan.md` 已重設為 `Current week: Week 01`。下次排程會用 freeze 後的 prompt / template / writing guideline 從 Week 01 重新產正式 learning packet；舊試跑內容不再作為已學過紀錄。
