...
- [19-interview-coaching-question-bank.md](19-interview-coaching-question-bank.md)：不是投遞前必讀全文；目前是 14 個主題的診斷池，並收斂成 30 題核心題，不是全刷。30 題核心已補入 slow query、consumer lag、Spring transaction 失效，避免太偏 Payment / Provider。只有 Nick 想用問答降低焦慮、檢查實力或開始模擬面試時才用，每輪只問 3-5 題。
