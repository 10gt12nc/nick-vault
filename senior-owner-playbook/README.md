...
- [22-career-industry-kb-evolution-plan.md](22-career-industry-kb-evolution-plan.md)：Codex automation 週報、工作 / 面試 / 日語推送，以及 `nick-vault` 未來升級成職涯證據庫、工作復盤、產業 KB 與 skill source 的草案；目前只是規劃，不是自動開工授權。
- [backend-weekly-plan.md](backend-weekly-plan.md)：48 週 Senior Java Backend / Platform Backend 核心循環 + 實戰輸出補強池；每週只聚焦 1 個主題，不累積學習債務，並把 Incident、Decision、Ownership 轉成可面試表達。
