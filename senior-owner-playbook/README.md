...
- [19-interview-coaching-question-bank.md](19-interview-coaching-question-bank.md)：不是投遞前必讀全文；目前題庫 v1.0 已定稿，不再加題。它保留 14 個主題的診斷池，並收斂成 30 題核心題；下一步是做 30 題答案草稿、錄音自講、最強 3 個 project story 3 分鐘版、四條核心 flow 白板講法與投遞 / 面試驗證。
