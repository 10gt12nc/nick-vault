...
- [19-interview-coaching-question-bank.md](19-interview-coaching-question-bank.md)：不是投遞前必讀全文；目前題庫 v1.0 已定稿，不再加題。它保留 14 個主題的診斷池，已收斂成 30 題核心題，並補完三個 project story。下一步是錄音自講、三個 story 練到 `30 秒 / 90 秒 / 3 分鐘`、四條核心 flow 白板講法與投遞 / 面試驗證。
