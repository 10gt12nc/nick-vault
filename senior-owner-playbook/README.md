...
- [18-system-design-templates.md](18-system-design-templates.md)：可選架構加強，把已完成 production flows 萃取成 0 到 1 system design 面試模板；目前已完成 Provider Integration template v1、Wallet / Bet-Settle template v1 與 MQ / Batch / Projection template v1。
...
主軸仍然是 production flow。`14`、`15`、`16`、`17`、`18` 是輔助層：卡住或要補全局 / 硬底子 / 職涯缺口 / 談薪策略 / system design 口說時再讀，不要拿來取代 flow。
