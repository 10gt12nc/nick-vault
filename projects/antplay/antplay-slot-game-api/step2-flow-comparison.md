...
| 順位 | Flow | 何時做 |
| --- | --- | --- |
| 2 | `transfer-wallet-money-in-out` | Step 4 已完成 / 2026-05-21；下一步做 Step 5 claim gate |
...
2026-05-21 更新: `slot-bet-settle-rollback` 已完成 Step 5，Rank 2 `transfer-wallet-money-in-out` 已完成 Step 4。Flow Track 下一步應繼續同一條 flow Step 5:
