...
2026-05-21 更新：`buy-free-scatter-rtp3-result-contract` 已完成 Step 4，材料位於 `flows/buy-free-scatter-rtp3-result-contract/`。本 flow 補上 `spn-math` RTP_3 / buy free / scatter direct evidence 與 game-api runtime caller，並已轉成 pricing / routing / result contract consistency 面試 case；下一步做 Step 5 單條 flow claim gate。
