...
| Flow packages | 第一條 `transfer-wallet-in-out-query` Step 5 已完成；不得宣稱全 project flow 完整 |
...
若 Nick 繼續同 project Flow Track，下一步回到 Step 2 ranking 的第二順位：`provider-callback-bet-settle-to-mq Step 3`。
