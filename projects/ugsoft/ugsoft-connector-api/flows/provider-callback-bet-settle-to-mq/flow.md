...
本 flow 已完成 Step 5。同 project 第三順位 `request-bet-record-mq-sync` 也已完成 Step 5，且 project-level `contribution claim consolidation refresh` 已完成。這是非 iwin 廣度補強；目前 connector 已收斂。
