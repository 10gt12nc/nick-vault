...
3. `agent-bonus-receive-transfer`：代理佣金領取 / 轉帳，涉及 Mongo money balance、Redis projection、GM 上分與防重複提交；已完成 Step 5，下一步 project-level consolidation。
...
| 文件 | 狀態 | 判斷 |
| --- | --- | --- |
| `projects/iwin/game_api/README.md` | 已建立 / 已同步 | 專案入口，已同步 coupon / partner 已完成 Step 5，agent bonus 已完成 Step 5，下一步 project-level consolidation |
