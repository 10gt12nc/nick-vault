...
| Step 2 | 可沿用 | 已同步 Step 5 完成與下一步轉 `game_api partner-deposit-withdraw-bill Step 4` |
...
- `game-round-record-query` Step 5 已完成，已判定不更新正式履歷 / 自傳；下一步轉 `iwin game_api partner-deposit-withdraw-bill Step 4`。
