...
- 下一步做 `iwin game_api contribution claim consolidation` 會收斂 coupon Step 5 的 project-level claim boundary，不會直接把 app_bi 人工入口或單條 game_api flow 寫成完整 project owner。
