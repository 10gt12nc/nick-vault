...
- payment project-level contribution consolidation 已收斂。
- `game_api coupon-redeem-credit-grant` 已完成 Step 4，下一步按 KB 應完成 Step 5 claim gate。
- 會產出是否能更新履歷 / 自傳的保守判斷；需要 commit，除非 Nick 明確說先不要。
