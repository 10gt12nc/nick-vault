...
3. `antplay-bet-settle-rollback`：Antplay 舊版 bet / settle / rollback 三段式流程，Step 4 已完成；Mongo step evidence、gameserver command 與 retry failure window 已轉成正式面試 case，下一步 Step 5。
...
| 文件 | 狀態 | 判斷 |
| --- | --- | --- |
| `projects/iwin/third_games_api/README.md` | 已建立 / 已同步 | 專案入口，已同步目前下一步為 `antplay-bet-settle-rollback Step 5` |
