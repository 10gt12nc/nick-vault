...
| 文件 | 狀態 | 判斷 |
| --- | --- | --- |
| `projects/iwin/third_games_api/README.md` | 已建立 / 已同步 | 專案入口，已同步目前下一步為 `gsc-seamless-withdraw-deposit-cancel Step 3` |
...
- `antplay-bet-settle-rollback Step 5` 已完成；下一步回 Step 2 ranking 第四候選，先確認 GSC 分離式 endpoint 是否值得進 Step 3。
