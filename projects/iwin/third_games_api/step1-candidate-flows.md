...
3. `antplay-bet-settle-rollback`：Antplay 舊版 bet / settle / rollback 三段式流程，Step 3 已完成；Mongo step evidence、gameserver command 與 retry failure window 已建立主學習包，下一步 Step 4。
...
| 文件 | 狀態 | 判斷 |
| --- | --- | --- |
| `projects/iwin/third_games_api/README.md` | 已建立 / 已同步 | 專案入口，已同步目前下一步為 `antplay-bet-settle-rollback Step 4` |
...
- `antplay-bet-settle-rollback Step 3` 已完成；下一步做 Step 4 面試 case。
