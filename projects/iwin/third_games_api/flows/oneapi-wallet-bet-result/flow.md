...
完成狀態：Step 5 已完成，已完成單條 flow claim gate；後續 `antplay-bet-settle-rollback` 也已完成 Step 5，third_games_api 本批代表 flow 已收斂，後續 `k3s-deploy gameserver-phased-rollout Step 5` 已完成。
