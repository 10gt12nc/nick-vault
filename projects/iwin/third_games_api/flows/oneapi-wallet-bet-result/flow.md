...
完成狀態：Step 5 已完成，已完成單條 flow claim gate；後續 `antplay-bet-settle-rollback` 也已完成 Step 5，目前下一步回同 project candidate ranking，做 `gsc-seamless-withdraw-deposit-cancel Step 3`。
