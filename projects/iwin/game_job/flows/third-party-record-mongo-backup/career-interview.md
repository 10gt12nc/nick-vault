...
Result：可面試講成 batch retention / partial failure / idempotent retry 題；正式履歷可保守寫「參與 GSC 第三方遊戲紀錄 Mongo 備份 job 的分批查詢與批次大小調整」，已由 `contribution-claim-consolidation.md` 收斂，但不可擴大成完整 retention owner。
