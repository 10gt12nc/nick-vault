...
Result：可面試講成 batch retention / partial failure / idempotent retry 題；正式履歷候選 evidence 可寫「參與 GSC 第三方遊戲紀錄 Mongo 備份 job 的分批查詢與批次大小調整」，但需先經 `game_job contribution claim consolidation`，但不可擴大成完整 retention owner。
