...
- `19-interview-coaching-question-bank.md` 題庫 v1.0 已定稿。除非 Nick 提供實際 JD、面試回饋、或指出題目明顯錯誤，AI 不得再主動加題、重排題庫或擴張面試題。下一步預設改成：30 題核心答案草稿、30 題錄音自講、最強 3 個 project story 練到 3 分鐘、投遞 / 面試驗證。
